...
$result = mysqli_query($mysqli, "SELECT * FROM car_product ORDER BY id DESC");
?>
...
<div class="row p-4">
    ...
    <a class="btn msg-btn" href="add.php">Add New Car</a>
    </div>
    <div class="col my-3 text-center">
    <a class="btn msg-btn" href="enqueries.php">Enquiries</a>
    </div>
    <div class="col my-3 text-center">
    <a class="btn msg-btn" href="buyqueue.php">Buy Queue</a>
    </div>
    <div class="col my-3 text-center">
    <a class="btn msg-btn" href="admin.php">Logout</a>
    </div>
    ...
    <tr>
    <th>ID</th> <th>Name</th> <th>Mileage</th> <th>Price</th> <th>FuelType</th> <th>Colour</th> <th>Image</th> <th>Manage</th>
    </tr>
    </thead>
    <?php  
    while($user_data = mysqli_fetch_array($result)) {         
        ...
        echo "<td>".$user_data['carname']."</td>";
        echo "<td>".$user_data['mileage']."</td>";
        echo "<td>".$user_data['price']."</td>";    
        echo "<td>".$user_data['fueltype']."</td>";
        echo "<td>".$user_data['colour']."</td>";
        echo "<td>".$user_data['img']."</td>";
        echo "<td><a href='edit.php?id=$user_data[id]'>Edit</a><br><a href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";        
    }
    ?>
    </table>
    </div>
